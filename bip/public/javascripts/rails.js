...
<script src="http://assets2.github.com/javascripts/bundle_github.js?b93c68c7f180addad844ab9e069d6cbeea277228" type="text/javascript"></script>
  ...
  <body class="logged_out ">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/rails/jquery-ujs/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3bbd0b7936cf08892e4ead7c98d80367fe0e202d'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/rails/jquery-ujs/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3bbd0b7936cf08892e4ead7c98d80367fe0e202d'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/rails/jquery-ujs/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3bbd0b7936cf08892e4ead7c98d80367fe0e202d'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/rails/jquery-ujs/watchers" title="Watchers" class="tooltipped downwards">643</a></li>
          <li class="forks"><a href="/rails/jquery-ujs/network" title="Forks" class="tooltipped downwards">48</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul class="tabs">
    ...
    <li><a href="/rails/jquery-ujs/network" highlight="repo_network">Network (48)</a></li>

    

    
      
      <li><a href="/rails/jquery-ujs/issues" highlight="issues">Issues (13)</a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/rails/jquery-ujs/edit/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="3bbd0b7936cf08892e4ead7c98d80367fe0e202d" /></div>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    <div class="human">
        ...
        <div class="message"><pre><a href="/rails/jquery-ujs/commit/ccfd88d1af0a3246739b4ff98281f07e82ead0ab">User config.action_view_javascript_expansions[:defaults] instead of creating an initializer file.</a> <a href="/rails/jquery-ujs/commit/ccfd88d1af0a3246739b4ff98281f07e82ead0ab#comments"><img alt="Comment" src="http://assets2.github.com/images/modules/dashboard/news/comment.png?b93c68c7f180addad844ab9e069d6cbeea277228" /></a></pre></div>
      

      <div class="actor">
        <div class="gravatar">
          
          <img src="http://www.gravatar.com/avatar/a955103782890eb2990826141b60d4ad?s=140&d=http%3A%2F%2Fgithub.com%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="30" height="30"  />
        </div>
        <div class="name"><a href="/siong1987">siong1987</a> <span>(author)</span></div>
        <div class="date">
          <abbr class="relatize" title="2010-09-10 00:20:13">Fri Sep 10 00:20:13 -0700 2010</abbr>
        </div>
      </div>
        ...
        <div class="actor">
          ...
          <div class="date"><abbr class="relatize" title="2010-09-10 05:16:20">Fri Sep 10 05:16:20 -0700 2010</abbr></div>
        </div>
      

    </div>
    <div class="machine">
      <span>c</span>ommit&nbsp;&nbsp;<a href="/rails/jquery-ujs/commit/ccfd88d1af0a3246739b4ff98281f07e82ead0ab" hotkey="c">ccfd88d1af0a3246739b</a><br />
      <span>t</span>ree&nbsp;&nbsp;&nbsp;&nbsp;<a href="/rails/jquery-ujs/tree/ccfd88d1af0a3246739b4ff98281f07e82ead0ab" hotkey="t">fb1fa55d28dcd617fdc6</a><br />
      
        <span>p</span>arent&nbsp;
        
        <a href="/rails/jquery-ujs/tree/17e4a9f3d7be6dd11c7d92856ea9ed3c8e81aadb" hotkey="p">17e4a9f3d7be6dd11c7d</a>
    ...
    <div id="path">
      <b><a href="/rails/jquery-ujs/tree/master">jquery-ujs</a></b> / <a href="/rails/jquery-ujs/tree/master/src">src</a> / rails.js       <span style="display:none" id="clippy_451">src/rails.js</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_451&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets2.github.com/flash/clippy.swf?v5"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_451&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div id="files">
      <div class="file">
        <div class="meta">
          <div class="info">
            <span class="icon"><img alt="Txt" height="16" src="http://assets0.github.com/images/icons/txt.png?a8d904cfd09ce483b6353756b4f21c88270db906" width="16" /></span>
...
<span id="LID133" rel="#L133">133</span>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2010 <span id="_rrt" title="0.07960s from fe4.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "3bbd0b7936cf08892e4ead7c98d80367fe0e202d"</script>
